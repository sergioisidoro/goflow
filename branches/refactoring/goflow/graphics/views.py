...
def pos_activity(request, process_id):
    ...
    activity_pos, created = ActivityPosition.objects.get_or_create(
                                activity=activity, diagram=process)
    ...
    request.user.message_set.create(
        message='activity %s is positioned in the diagram of process %s.' % (
